...
void Do_Init(void)
{
    ...
    init_IO();
    OSCCON=0x70; // Set oscillator to 8 MHz  TRISB = 0x?? // Configure the PORTB to make sure
    ...
    INTCONbits.INT0IE = 1;       // SET INT0IE
    INTCON3bits.INT1IE = 1;      // SET INT1IE
    INTCON3bits.INT2IE = 1;      // SET INT2IE
